...
import { FUJI_RELEASE_CONFIG, assertFujiAddress, encodeCreateFujiEdition, sendFujiTransaction } from "../lib/fuji-release.js";
...
function initialForms() {
  return {
    ...
    edition: { id: "", name: "", description: "", artwork: "", chainId: "43113", contractAddress: "", tokenId: "", quantity: "", metadataUri: "", priceWei: "", marketplace: "{}", status: "DRAFT" },
