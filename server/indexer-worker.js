...
export function createIndexerWorker({ config = loadServerConfig(process.env, { requireIndexerContracts: true }), pool = null, logger = console, sleep = (ms) => new Promise((resolve) => setTimeout(resolve, ms)) } = {}) {
